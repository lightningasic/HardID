/*
 * HardID — secp256k1 backend for ESP32-P4 (RISC-V)
 * Copyright (C) 2026 LightningASIC / HardID contributors
 * License: Apache License 2.0
 *
 * ESP32-P4 uses the ilp32f ABI (32-bit), so the compiler does NOT support
 * `unsigned __int128` and core/secp256k1.c cannot build for this target.
 * This file provides the same secp256k1.h interface on top of mbedTLS
 * (which ESP-IDF links anyway), identical to the ESP32-S3 fallback.
 * Interface contract (secp256k1.h) is unchanged.
 *
