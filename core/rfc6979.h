...
/* Generate deterministic nonce k (1..n-1) for secp256k1 from a 32-byte
 * private key and 32-byte message hash. retry skips candidates (RFC 6979
 * §3.2 step h loop); pass 0 for the first. Returns 0 on success. */
